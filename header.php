...
<body <?php body_class(); ?>>
<div id="page" class="site row expanded large-unstack align-stretch">
	...
	<aside class="sq-sidebar large-3 xlarge-2 columns">
		<header id="masthead" class="site-header" role="banner">
			<div class="sq-branding">
				<a class="button menu-toggle" data-toggle="js-menu-toggle"><i class="fa fa-bars"></i></a>
				<?php
				the_custom_logo();
		...
		<div id="js-menu-toggle" class="widget-area" data-toggler=".show" data-animate="fade-in fade-out">
			<?php
